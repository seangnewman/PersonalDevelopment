...
function findAddress() {
  ...
  // Modify to locate the current position
...
function success(position){
  ...
  document.getElementById('lat').value = geoLatitude;
  document.getElementById('lng').value = geoLongitude;
...
function findPlaces() {
    ...
    var cur_location = new google.maps.LatLng(geoLatitude, geoLongitude);
